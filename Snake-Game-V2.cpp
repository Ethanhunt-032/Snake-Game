...
#include <windows.h> 
using namespace std; 
static int high_score=INT_MIN;
static string high_score_Player = "";
...
{ 
    ...
    if(playerScore > high_score)
    {
        ...
        high_score_Player = playerName;
    }
    cout << playerName << "'s Score: " << playerScore 
         << endl; 
    cout <<"Highest Score by :" << high_score_Player << "->" << high_score 
         << endl; 
} 
